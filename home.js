...
function canWeDeliver(zipCode) {
    for ( let zips of deliveryAreaZipCodes) {
      if (zipCode === zips) {
...
function canWeDliverTwo(zips) {
    if(deliveryAreaZipCodes.includes(zips)) {
      return console.log("You're in our delivery zone")
    }
    else {
      return console.log("Sorry, we can't deliver to that address.")
  ...
  canWeDliverTwo(85213)
  canWeDliverTwo(98031)
...
let titleChange = deals[0].title.replace(15, 10)
...
let dealExtension = deals[1].desc.replace("March", "April");